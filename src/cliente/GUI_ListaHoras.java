...
public class GUI_ListaHoras extends javax.swing.JFrame {
    
    GestorInfoClient cliente;
    
    public GUI_ListaHoras() {
        initComponents();
    }

    public GUI_ListaHoras(GestorInfoClient cliente) {
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if(boxMes.getSelectedIndex() != -1){
            ...
            limpiarTabla(modelo);
            try {
                ArrayList lita = cliente.punto_b(mes, Integer.parseInt(dia));
                llenarTabla(modelo, lita);
            } catch (RemoteException ex) {
                Logger.getLogger(GUI_ListaHoras.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void llenarTabla(DefaultTableModel modelo, ArrayList lista){
        
        StringTokenizer st;
        for(Object r:lista){
            st = new StringTokenizer((String)r,"-",false);
            ArrayList tokens = new ArrayList();
            while (st.hasMoreTokens()){  
                tokens.add(st.nextToken());   
            }
            modelo.addRow(new Object[]{Integer.parseInt((String)tokens.get(0)),(String)tokens.get(3),Double.parseDouble((String)tokens.get(4))});
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_ListaHoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_ListaHoras().setVisible(true);
            }
        });
    }
